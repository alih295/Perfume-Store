...
function Context({ children }) {
  const product = [
    ...
    },
    {
      ...
      title: "Golden Aura",
      description:
        "A sparkling, fresh perfume with hints of citrus and vanilla.",
      src: "../../public/scentsimg/4.jpeg",
      price: 2600,
      qty: 1,
    },
    {
